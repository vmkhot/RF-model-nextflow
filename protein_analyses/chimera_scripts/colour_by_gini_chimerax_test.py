...
def run_script(session, tsv_file=None, model="#1", palette_color="bf22a2ff"):
    ...
    # 4. Write attribute file: TSV positions get their RAW (native) value,
    ...
    run(session, f"color byattribute gini {model} palette white:{palette_color} range {vmin},{vmax}")
